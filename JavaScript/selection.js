...
informations.innerHTML += `
    ...
    <p class="fs-5">Référence : <span class="fw-bold">${order.orderId}</span>.</p>
    <p class="fs-5">Votre facture sera envoyée par mail à l'adresse suivante : <span class="fw-bold">${order.contact.email}</span>.</p>
    <p class="fs-5">Votre commande sera envoyée par mail à l'adresse suivante :
